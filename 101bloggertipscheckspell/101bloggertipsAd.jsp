...
//var blankURL="/jspellhtml/blank.html"; // uncomment if using SSL
...
var directmode=true; // is highlighting done in original text control or is there a preview panel 
